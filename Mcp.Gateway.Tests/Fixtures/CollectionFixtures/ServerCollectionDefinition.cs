namespace Mcp.Gateway.Tests.Fixtures.CollectionFixtures;
...
public class ServerCollectionDefinition : ICollectionFixture<McpGatewayFixture> //, ICollectionFixture<OtherFixture>, ICollectionFixture<AnotherFixture>
{
