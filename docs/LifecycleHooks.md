...
```prometheus
# HELP mcp_tool_invocations_total Total tool invocations
# TYPE mcp_tool_invocations_total counter
mcp_tool_invocations_total{tool="add_numbers"} 150
mcp_tool_invocations_total{tool="divide"} 50
mcp_tool_invocations_total{tool="slow_operation"} 10

# HELP mcp_tool_successes_total Successful tool invocations
# TYPE mcp_tool_successes_total counter
mcp_tool_successes_total{tool="add_numbers"} 150
mcp_tool_successes_total{tool="divide"} 48
mcp_tool_successes_total{tool="slow_operation"} 10

# HELP mcp_tool_failures_total Failed tool invocations
# TYPE mcp_tool_failures_total counter
mcp_tool_failures_total{tool="divide",error_type="TargetInvocationException"} 2

# HELP mcp_tool_duration_seconds Tool execution duration in seconds
# TYPE mcp_tool_duration_seconds histogram
mcp_tool_duration_seconds_bucket{tool="add_numbers",le="0.005"} 45
mcp_tool_duration_seconds_bucket{tool="add_numbers",le="0.01"} 150
mcp_tool_duration_seconds_sum{tool="add_numbers"} 0.18435
mcp_tool_duration_seconds_count{tool="add_numbers"} 150
```
...
See `Examples/MetricsMcpServerTests` for integration tests covering:
...
- No aggregation across multiple instances

**Workarounds:**
- Use custom hooks with external metrics systems (Prometheus, DataDog)
- Export metrics periodically to persistent storage
- Use centralized metrics aggregation

### Future (v1.9.0+)

Planned improvements:
- Optional Redis-backed metrics
...
- [Examples/MetricsMcpServer](../Examples/MetricsMcpServer/README.md) - Complete example with metrics endpoint
- [v1.8.0 Release Notes](../.internal/notes/v1.8.0/v1.8.0-enhancements.md) - Full v1.8.0 changelog
- [Prometheus .NET Client](https://github.com/prometheus-net/prometheus-net) - Prometheus integration
- [Application Insights](https://learn.microsoft.com/azure/azure-monitor/app/asp-net-core) - Azure monitoring
