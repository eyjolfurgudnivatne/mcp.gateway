namespace DateTimeMcpServerTests.Fixture;
...
public class ServerCollectionDefinition : ICollectionFixture<DateTimeMcpServerFixture> //, ICollectionFixture<OtherFixture>, ICollectionFixture<AnotherFixture>
{
