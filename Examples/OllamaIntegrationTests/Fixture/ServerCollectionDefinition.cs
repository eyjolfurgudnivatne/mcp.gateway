namespace OllamaIntegrationTests.Fixture;
...
public class ServerCollectionDefinition : ICollectionFixture<OllamaIntegrationFixture> //, ICollectionFixture<OtherFixture>, ICollectionFixture<AnotherFixture>
{
