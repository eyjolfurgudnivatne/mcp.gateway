...
public class SimplePrompt
{
        ...
        return ToolResponse.Success(
            ...
            new PromptResponse(
                ...
                Arguments: new {
                    ...
                    behavior = new {
                        type = "string",
                        description = "Behavior of the kid (e.g., Good, Naughty)",
    ...
    public record LetterToSantaRequest(
        ...
        [property: Description("Name of the kid")] string Name,
        [property: JsonPropertyName("behavior")]
        [property: Description("Behavior of the kid (e.g., Good, Naughty)")] BehaviorEnum Behavior,
