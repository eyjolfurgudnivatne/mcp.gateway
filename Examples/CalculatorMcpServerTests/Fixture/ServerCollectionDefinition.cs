namespace CalculatorMcpServerTests.Fixture;
...
public class ServerCollectionDefinition : ICollectionFixture<CalculatorMcpServerFixture> //, ICollectionFixture<OtherFixture>, ICollectionFixture<AnotherFixture>
{
